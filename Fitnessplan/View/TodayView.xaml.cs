...
namespace Fitnessplan.View
{
    ...
    /// </summary>
    public sealed partial class TodayView : IView
    {
        ...
        {
            var addDays = (int) navigationParameter;
            if(addDays != 0)
                _viewModel = new TodayViewModel(DateTime.Now);
            else
                _viewModel = new TodayViewModel(DateTime.Now.AddDays(addDays));
            ...
            else
            {
                ...
                if (pageState.ContainsKey("SelectedItem"))
                {
                    // TODO: this.itemsViewSource.View.MoveCurrentTo() mit dem ausgewählten
        ...
        protected override void SaveState(Dictionary<String, Object> pageState)
        {
            ...
            //    //       pageState["SelectedItem"] zuweisen
            //}
        }
